  ...
  return (
    <div className="w-full flex items-center justify-between bg-black px-6 py-4 ">
      <div className="relative">
        <div className="absolute w-full top-1 bottom-0 bg-[linear-gradient(to_right,rgba(255,243,176,0.5),_rgba(255,215,0,0.5),_rgba(218,165,32,0.5),_rgba(13,13,13,0.15))]"></div>
        <Image
