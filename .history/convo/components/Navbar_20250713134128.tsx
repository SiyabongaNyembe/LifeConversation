  ...
  return (
    <div className="w-full flex items-center justify-between bg-black px-6 py-4 ">
      ...
      <nav className="flex gap-30">
        <a href="#" className="text-opacity-60 text-white">
          About
        </a>
        <a href="#" className=" text-white text-opacity-10">
          Services
        </a>
        <a href="#" className="text-opacity-60 text-white">
          Seminars
        </a>
        <a href="#" className="tt-opacity-60 text-white">
          Store
        </a>
        <a href="#" className="opacity-60 text-white">
          Library
        </a>
        <a href="#" className="text-white opacity-60">
          Contact Us
        </a>
      </nav>
    </div>
